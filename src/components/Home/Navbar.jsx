...
import { Menu, X, Home, Layers, Info, ChevronRight, Sparkles, Leaf, User } from 'lucide-react';
            ...
            <div className="p-6 space-y-3">
              ...
              <div className="pt-6 mt-4 border-t border-white/10 space-y-3">
                <button
                  ...
                  className="relative w-full py-4 bg-white text-[#063e2a] font-bold rounded-2xl hover:bg-gray-100 transition-all duration-300 flex items-center justify-center gap-2 group active:scale-95 shadow-lg hover:shadow-xl overflow-hidden"
                >
                  <User className="w-5 h-5 text-[#063e2a]" />
                  <span className="relative z-10">View Profile</span>
                </button>
                <button className="relative w-full py-4 bg-transparent border border-white/20 text-white font-bold rounded-2xl hover:bg-white/10 transition-all duration-300 flex items-center justify-center gap-2 group active:scale-95 overflow-hidden">
                  <span className="relative z-10 flex items-center gap-2">
                    Get Started
